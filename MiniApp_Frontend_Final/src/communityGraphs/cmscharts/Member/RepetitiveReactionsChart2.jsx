...
const RepetitiveReactionsChart = () => {
  ...
  // Function to fetch data from Backend (currently commented out)
  ...
  useEffect(() => {
    ...
    // Hardcoded test data for Repetitive Reactions
    const testLabels = ["Member1", "Member2", "Member3", "Member4", "Member5"];
    const testData = [12, 9, 15, 8, 10]; // Number of reactions (likes, emojis)

    setChartData({
      labels: testLabels,
      datasets: [
        {
          label: "Number of Reactions (e.g., likes, emojis)", // Updated label
          data: testData,
          ...
          options={{
            ...
            plugins: {
              ...
              tooltip: {
                callbacks: {
                  label: (tooltipItem) => {
                    return `Reactions (e.g., likes, emojis): ${tooltipItem.raw}`; // Tooltip shows reaction count
                  },
                },
              },
            },
            scales: {
              ...
              y: {
                title: {
                  display: true,
                  text: "Number of Reactions", // Y-axis title updated
                  color: "white",
                },
                ticks: {
                  color: "#fff", // X-axis tick color
